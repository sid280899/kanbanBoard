...
// // To chnging yellow border around the color box presnt in the priority-color-cont
...
// To add the ticket in the main-cont
...
function createTicket(task, modalPriorityColor, ticketId) {
  ...
  handelLockUnlock(ticketCont, id);
  handelDelete(ticketCont, id);
  handelPriority(ticketCont, id);
}

function handelPriority(ticketCont, id) {
...
function handelLockUnlock(ticketCont, id) {
  //handel lock unlock
...
function handelDelete(ticketCont, id) {
  //handle delete
